...
/* Да, я уже сдал работу и вспомнил что в вызове надо передавать настройки, пока исправлял увидел
ответ от вас). Спасибо за советы по поводу попапов, в следущих проектах постараюсь не допускить
таких ошибок) */
